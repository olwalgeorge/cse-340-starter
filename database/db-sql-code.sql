...
-- These queries should be run AFTER the database and data are created

-- Task 4: Update GM Hummer record to change "small interiors" to "a huge interior"
